...
```
python -m dreambooth_stable_diffusion --base configs/stable-diffusion/v1-finetune_unfrozen.yaml 
                -t 
...
![](dreambooth_stable_diffusion/assets/a-container-0038.jpg)

After training, generated images with prompt ```photo of a sks container```:

![](dreambooth_stable_diffusion/assets/photo-of-a-sks-container-0018.jpg)

Generated images with prompt ```photo of a sks container on the beach```:

![](dreambooth_stable_diffusion/assets/photo-of-a-sks-container-on-the-beach-0017.jpg)

Generated images with prompt ```photo of a sks container on the moon```:

![](dreambooth_stable_diffusion/assets/photo-of-a-sks-container-on-the-moon-0016.jpg)

Some not-so-perfect but still interesting results:

Generated images with prompt ```photo of a red sks container```:

![](dreambooth_stable_diffusion/assets/a-red-sks-container-0021.jpg)

Generated images with prompt ```a dog on top of sks container```:

![](dreambooth_stable_diffusion/assets/a-dog-on-top-of-sks-container-0023.jpg)
